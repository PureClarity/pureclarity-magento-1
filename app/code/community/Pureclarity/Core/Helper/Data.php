...
class Pureclarity_Core_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    public function isFeedNotificationActive()
    {
        return Mage::getStoreConfig("pureclarity_core/environment/notify_feed");
    }

    public function getAccessKey()
    {
        return Mage::getStoreConfig("pureclarity_core/credentials/access_key");
    }
    ...
    public function isBrandFeedEnabled()
    {
        return Mage::getStoreConfig("pureclarity_core/brand_feed/enabled");
    }
